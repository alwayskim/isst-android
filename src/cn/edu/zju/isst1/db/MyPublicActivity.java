...
public class MyPublicActivity implements Serializable {
     ...
     *
     */
    private static final long serialVersionUID = 5026842607313893078L;
    ...
    public MyPublicActivity(JSONObject jsonObject) throws JSONException {
        id = -1;
        title = "";
        imgUrl = "";
        cityId = -1;
