 ...
 */
public class RestaurantRequest extends CSTJsonRequest{
    ...
    public RestaurantRequest(int method, String subUrl,
    ...
    public RestaurantRequest setPage(int page) {
        this.page = page;
        hasParams = true;
        return this;
    }

    public RestaurantRequest setPageSize(int pageSize) {
        this.pageSize = pageSize;
        hasParams = true;
        return this;
    }

    public RestaurantRequest setKeywords(String keywords) {
