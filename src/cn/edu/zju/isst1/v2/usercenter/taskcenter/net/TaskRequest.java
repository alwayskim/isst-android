 ...
 */
public class TaskRequest extends CSTJsonRequest{
    ...
    public TaskRequest(int method, String subUrl, Map<String, String> params, CSTResponse<JSONObject> response) {
    ...
    public TaskRequest setPage(int page) {
        this.page = page;
        hasParams = true;
        return this;
    }

    public TaskRequest setPageSize(int pageSize) {
        this.pageSize = pageSize;
        hasParams = true;
        return this;
    }

    public TaskRequest setKeywords(String keywords) {
