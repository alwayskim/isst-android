...
import cn.edu.zju.isst.v2.contact.contact.data.CSTContactFilter;

/**
 * Created by tan on 2014/8/29.
 */
public class CSTContactFilterActivity extends BaseActivity {
     ...
     *
     */
    public CSTContactFilterActivity() {
    ...
    class onBtnOkClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            data.putExtra("mFilter", (Serializable) uf);
    ...
    class onBtnCancelClickListener implements View.OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            CSTContactFilterActivity.this.finish();
        }
    }
